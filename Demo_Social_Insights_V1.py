				...
				if hcpname is not None and hcpname!=" ":
					...
					with st.spinner("Ploting the Graphs"):
						...
						with col6:
							...
							highlighted_text2 = f"<p style='color: black;''font-weight: bold;'><span style='color: orange;''font-weight: bold;'>{hcpname}</span> is discussing <span style='color: blue;'>{val.index[0]} </span>as a key area of focus with <span style='color: green;'font-weight: bold;'>{round(val[1],2)}%</span> engagement rate.</p>"
							highlighted_text3 = f"<p style='color: black;''font-weight: bold;'><span style='color: orange;''font-weight: bold;'>{hcpname}</span> is discussing <span style='color: blue;'>{val.index[0]} </span>as a key area of focus with <span style='color: green;'font-weight: bold;'>{round(val[2],2)}%</span> engagement rate.</p>"
